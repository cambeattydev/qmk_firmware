 ...
 * |--------+------+------+------+------+------| Copy |           |PASTE |------+------+------+------+------+--------|
 * | Home   |Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl|  End   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L1  |  L3  |AltShf|  (   |   )  |                                       |  {   |  }   |   [  |   ]  |  L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 ...
 *
 * ,-------------------------------------------------------.           ,--------------------------------------------------.
 * |Escape     |  F1  |  F2  |  F3  |  F4  |  F5    | F6   |           |  F7  | F8   |  F9  |  F10 |  F11 |  F12 |  CALC  |
 * |-----------+------+------+------+------+--------+------|           |------+------+------+------+------+------+--------|
 * |           |   x  |   x  |   x  |   x  |Ctrl(T) |Alt ` |           |  +   |   Up |   7  |   8  |   9  |   *  |        |
 * |-----------+------+------+------+------+--------|      |           |      |------+------+------+------+------+--------|
 * |AltShiftF12|   x  | Save |   x  | Find |   x    |------|           |------| Down |   4  |   5  |   6  |   /  | Clear  |
 * |-----------+------+------+------+------+--------|Alt   |           |  -   |------+------+------+------+------+--------|
 * | CtrlAlt P |   x  |   x  |   x  |   x  |CtlSpace|Enter |           |      |   &  |   1  |   2  |   3  | Ctrl |        |
 * `-----------+------+------+------+------+---------------'           `-------------+------+------+------+------+--------'
 *   |         |      |      |      |      |                                         |   0  |    . |   0  |   =  |      |
 *   `-------------------------------------'                                         `----------------------------------'
 *                                             ,-------------.       ,-------------.
...
[CODENUM] = LAYOUT_ergodox(
       ...
       KC_AttachToProcess,KC_LCTL,KC_NO,KC_NO,KC_NO,KC_CTL_SPC,LALT(KC_ENT),
          KC_TRNS,KC_NO,KC_NO,KC_TRNS,KC_TRNS,
                                       KC_TRNS,KC_TRNS,
                                               KC_TRNS,
                               KC_TRNS,KC_TRNS,KC_TRNS,
       // right hand
       KC_F7, KC_F8,  KC_F9 ,  KC_F10,   KC_F11,   KC_F12,  KC_CALC,
       KC_PLUS, KC_UP,   KC_7,   KC_8,    KC_9,    KC_ASTR, KC_NO ,
                KC_DOWN, KC_4,   KC_5,    KC_6,    KC_SLSH, KC_CLEAR,
       KC_MINS, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_RCTL, KC_TRNS,
